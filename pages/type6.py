...
gb.logo()
model = gb.initialize_vertexai()  # Initialize Vertex
bucket = gb.initialize_gcs()  # Initialize GC AI

gb.button_main_page()

st.markdown("#### เพื่อดูอดีต ปัจจุบัน อิทธิพลที่ซ่อนอยู่ อุปสรรค อิทธิพลภายนอก คำแนะนำ และผลลัพธ์ที่น่าจะเกิดขึ้น")
gb.focus('no input')
