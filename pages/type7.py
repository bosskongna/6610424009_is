...
def main():
    ...
    st.markdown("#### เปิดไพ่แบบ Celtic Cross (10 ใบ)")
    st.write("การทำนายด้วยไพ่ 10 ใบ แสดงถึงสถานการณ์ปัจจุบัน สิ่งที่ท้าทาย เป้าหมาย รากฐาน อดีต อนาคต ตัวคุณ สิ่งรอบตัว ความหวัง และผลลัพธ์")
