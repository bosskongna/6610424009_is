...
os.environ["GOOGLE_CLOUD_PROJECT"] = "mutelu-chat"  # Change this to your actual project ID
...
# Streamlit App
def main():
    st.write("คำเตือน: การเปิดไพ่รายวัน ควรเปิดแค่วันละ 1 ครั้ง")

    # Fetch Tarot Data from local file
    tarot_data = fetch_local_tarot_data(TAROT_DATA_FILE)
