...
gb.initialize_vertex_ai()
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = st.secrets["gcs"]["temp_credentials_path"]
os.environ["GOOGLE_CLOUD_PROJECT"] = st.secrets["gcs"]["project_id"]
